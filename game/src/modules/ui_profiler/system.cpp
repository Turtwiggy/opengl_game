...
void
game2d::ProfilerSystem::init(game2d::Coordinator& registry)
{
  auto r = registry.create_entity();
  registry.add_component<ProfilerComponent>(r, ProfilerComponent{});
};

void
game2d::ProfilerSystem::update(game2d::Coordinator& registry, engine::Application& app)
{
  ...
  for (const auto& entity : entities) {
    ...
    // Profiler
    const auto& p = registry.get_component<ProfilerComponent>(entity);
