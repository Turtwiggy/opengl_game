...
bool
key_held(SINGLETON_InputComponent& input, SDL_Scancode button);
...
void
process_controller_added();
void
process_controller_removed();

// keyboard
[[nodiscard]] bool
get_key_down(SDL_Scancode button);
[[nodiscard]] bool
get_key_up(SDL_Scancode button);
[[nodiscard]] bool
...
[[nodiscard]] bool
get_mouse_lmb_held() const;
[[nodiscard]] bool
get_mouse_rmb_held() const;
[[nodiscard]] bool
get_mouse_mmb_held() const;
[[nodiscard]] bool
get_mouse_lmb_press() const;
[[nodiscard]] bool
get_mouse_rmb_press() const;
[[nodiscard]] bool
get_mouse_mmb_press() const;
[[nodiscard]] bool
...
get_mouse_pos() const;
void
set_mousewheel_y(const float amount);
[[nodiscard]] float
get_mousewheel_y() const;
...
[[nodiscard]] float
get_axis_dir(SDL_GameController* controller, SDL_GameControllerAxis axis);
