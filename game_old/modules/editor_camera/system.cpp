...
void
game2d::init_editor_camera_system(game2d::Coordinator& registry){
  //
};

void
game2d::update_editor_camera_system(game2d::Coordinator& registry, engine::Application& app, float dt)
{
