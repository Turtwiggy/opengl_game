...
void
render_number(game2d::Coordinator& registry, int number, float x, float y)
{
...
void
create_hex_cell(game2d::Coordinator& registry, const int x, const int y, const int i, glm::ivec2 offset)
{
...
void
game2d::init_hex_grid_system(game2d::Coordinator& registry, const glm::ivec2& screen_wh)
{
...
void
game2d::update_hex_grid_system(game2d::Coordinator& registry, engine::Application& app, float dt)
{
