...
void
CALLBACK_actor_solid_collision(game2d::Coordinator& registry, const CollisionInfo2D& info)
{
...
void
CALLBACK_do_nothing(game2d::Coordinator& registry, const CollisionInfo2D& eid){
...
void
game2d::update_move_objects_system(game2d::Coordinator& registry, engine::Application& app, float dt)
{
  std::function<void(game2d::Coordinator&, CollisionInfo2D&)> actor_hit_solid_callback = CALLBACK_actor_solid_collision;
  std::function<void(game2d::Coordinator&, CollisionInfo2D&)> actor_being_squish_callback = CALLBACK_do_nothing;
