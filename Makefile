...
ENGINE_PRJ_DIR = thirdparty/engine
PRJ_DIR = game

# engine deps...
ASSETS_HTML_TEMPLATE = $(ENGINE_PRJ_DIR)/assets/emscripten/shell_minimal.html
ENGINE_SRC_DIR = $(ENGINE_PRJ_DIR)/engine
IMGUI_DIR = $(ENGINE_PRJ_DIR)/thirdparty/imgui
SDL2_DIR = $(ENGINE_PRJ_DIR)/thirdparty/sdl2/x86_64-w64-mingw32
GLEW_DIR = $(ENGINE_PRJ_DIR)/thirdparty/glew
...
$(OBJ_DIR)/%.o:$(ENGINE_SRC_DIR)/opengl/%.cpp
	$(CXX) $(CXXFLAGS) -c $< -o $@
